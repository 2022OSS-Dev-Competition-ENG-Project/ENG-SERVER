...
public class FacilityConstant {
    ...
    public static final String REGISTER_VALID_CONFLICT_ADDRESS = "매니저의 계정만 시설물을 등록할수 있습니다.";
    ...
    public static final String FACILITY_CHANGE_ADDRESS = "정상적으로 시설물 이름을 변경하였습니다";

    /* 시설물 삭제 */
    public static final String FACILITY_DELETE_COMPLETE = "정상적으로 시설물을 삭제 하였습니다.";
    public static final String FACILITY_DELETE_FAIL = "시설물의 최고 관리자만 삭제가 가능합니다.";
